...
'VCI_ReadCanStatus'
Public Declare Function VCI_ReadCANStatus Lib "VCI_CAN.dll" (ByVal DevType As Long, ByVal DevInd As Long, ByVal CANIndex As Long, ByRef pCANstatus As PVCI_CAN_STATUS) As Long
